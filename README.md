...
| `Laboratorios/XML-y-SQL-MBDA` | [Laboratorio 06: XML y SQL](https://github.com/JuanGuayazanC/XML-y-SQL-MBDA) *(solo documentación — sin entrega registrada)* |
...
| `Autoestudios/PLSQL-Basico-Paquetes-MBDA` | [Autoestudio 05: PL/SQL Básico — Paquetes](https://github.com/JuanGuayazanC/PLSQL-Basico-Paquetes-MBDA) *(solo documentación — sin entrega registrada)* |
| `Autoestudios/XML-Basico-MBDA` | [Autoestudio 06: XML Básico](https://github.com/JuanGuayazanC/XML-Basico-MBDA) *(solo documentación — sin entrega registrada)* |
